    ...
    .then(json => {
        ...
        clusters = L.markerClusterGroup.layerSupport({
            iconCreateFunction: function(cluster) {
                ...
                } else if (cluster._cLatLng.lat == '44.84', cluster._cLatLng.lng == '11.62'){
                    clusterColor = "rgba(254,191,229.0.8)"
                } else if (cluster._cLatLng.lat == '46.21', cluster._cLatLng.lng == '6.14'){
                    clusterColor = "rgba(194,243,253,0.8)"
                } else if (cluster._cLatLng.lat == '46.66', cluster._cLatLng.lng == '9.63'){
                    clusterColor = "rgba(230,0,0,0.8)"
                } else if (cluster._cLatLng.lat == '48.21', cluster._cLatLng.lng == '16.36'){
                    clusterColor = "rgba(255,255,0,0.8)"
                } else if (cluster._cLatLng.lat == '52.37', cluster._cLatLng.lng == '4.89'){
                    clusterColor = "rgba(180,253,223,0.8)"
                } else if (cluster._cLatLng.lat == '41.01', cluster._cLatLng.lng == '28.96'){
                    clusterColor = "rgba(0,0,0,0.8)"
                } else if (cluster._cLatLng.lat == '52.23', cluster._cLatLng.lng == '21.02'){
                    clusterColor = "rgba(214,216,255,0.8)"
                } else if (cluster._cLatLng.lat == '38.72', cluster._cLatLng.lng == '-9.13'){
                    clusterColor = "rgba(255,253,180,0.8)"
                } else if (cluster._cLatLng.lat == '41.89', cluster._cLatLng.lng == '12.51'){
                    clusterColor = "rgba(239,202,253,0.8)"
                } else if (cluster._cLatLng.lat == '45.06', cluster._cLatLng.lng == '7.68'){
                    clusterColor = "rgba(226,253,211,0.8)"
                } else if (cluster._cLatLng.lat == '51.05', cluster._cLatLng.lng == '13.35'){
                    clusterColor = "rgba(253,217,198,0.8)"
                } else if (cluster._cLatLng.lat == '55.95', cluster._cLatLng.lng == '-3.19'){
                    clusterColor = "rgba(255,255,190,0.8)"
                } else if (cluster._cLatLng.lat == '40.43', cluster._cLatLng.lng == '-3.7'){
                    clusterColor = "rgba(234,234,234,0.8)"
                } else if (cluster._cLatLng.lat == '46.94', cluster._cLatLng.lng == '7.45'){
                    clusterColor = "rgba(184,0,230,0.8)"
                } else if (cluster._cLatLng.lat == '43.46', cluster._cLatLng.lng == '11.14'){
                    clusterColor = "rgba(187,223,254,0.8)"
                } else if (cluster._cLatLng.lat == '45.44', cluster._cLatLng.lng == '12.33'){
                    clusterColor = "rgba(156,156,156,0.8)"
                } else {
                    clusterColor = "white"
                };
                if (cluster._cLatLng.lat == '41.01', cluster._cLatLng.lng == '28.96'){
                    clusterTextColor = "white",
                    clusterBorder = "solid white"
                } else {
